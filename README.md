...
- **개발자 (역할):** 4명 (게시판 신고, 신고 관리자 게시판, 회원 알림, 회원 상태 변경, 친구 관리, Q&A 챗봇, 포인트 사용 및 획득, 커뮤니티 게시판(공동제작) 기능 담당)
...
**기본적으로 소모임 참여 신청을 위한 포인트를 획득하려면 결제가 필요하지만 출석체크와 게시판 글 작성, 소모임 개최 등을 통해서 포인트 획득이 가능합니다. 이 방식을 통해 과금하지 않거나 소과금 유저도 사용이 원활하게 하여 사용자들의 접근성을 높일 뿐만 아니라, 주기적인 출석체크와 활발한 커뮤니티 게시글 리젠, 활발한 소모임 개최를 유도하여 사이트가 활성화되고 지속적으로 발전할 수 있도록 돕습니다. 이 지속적인 성장이 가능한 수익 모델을 통해 사이트의 장기적인 성장을 보장합니다.**
