...
public class QChatParticipant extends EntityPathBase<ChatParticipant> {
    ...
    private static final long serialVersionUID = -1211509520L;
    ...
    public final QChattingRoom room;
    ...
    public QChatParticipant(Class<? extends ChatParticipant> type, PathMetadata metadata, PathInits inits) {
        ...
        this.room = inits.isInitialized("room") ? new QChattingRoom(forProperty("room"), inits.get("room")) : null;
